...
TOOL_SPECS: dict[str, dict[str, Any]] = {
    "log_bill": {"impl": h._add_recurring_bill, "tabs": ["schedule", "forecast", "today", "calendar"]},
    "get_bills": {"impl": h._get_bills, "tabs": []},
    "edit_bill": {"impl": h._edit_bill, "tabs": ["schedule", "forecast", "today", "calendar"]},
    "delete_bill": {"impl": h._delete_bill, "tabs": ["schedule", "forecast", "today", "calendar"]},
    ...
    "add_calendar_event": {"impl": h._add_calendar_event, "tabs": ["dashboard", "schedule", "calendar", "today"]},
    ...
    "add_task": {"impl": h._add_task, "tabs": ["schedule", "today", "calendar"]},
    "edit_task": {"impl": h._edit_task, "tabs": ["schedule", "today", "calendar"]},
    "complete_task": {"impl": h._complete_task, "tabs": ["schedule", "today", "calendar"]},
    "delete_task": {"impl": h._delete_task, "tabs": ["schedule", "today", "calendar"]},
