...
Usage:
    python -m backend.backup                  # local
    python -m backend.backup --max-backups 7  # keep only last 7

The backup directory defaults to /data/backups (for Railway volumes) or
./backups locally. Override with BACKUP_DIR env var.
"""
