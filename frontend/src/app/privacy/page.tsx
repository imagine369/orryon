  ...
  return (
    ...
    <div className="flex-1 max-w-2xl mx-auto px-4 py-12 w-full">
      ...
      <div className="prose prose-invert prose-sm max-w-none">
        ...
        <p>When you use the AI assistant, your messages and a limited, relevant summary of your data (e.g., recent transactions, current budgets, or active goals) may be transmitted to third-party AI providers such as xAI (Grok API). We do not transmit your full database or raw financial history. We maintain a list of subprocessors and service providers, which we update from time to time. Current subprocessors include xAI (for AI processing), Stripe (for billing), and optional SMTP providers (for transactional emails you configure). Review xAI's privacy policy at https://x.ai/legal/privacy-policy and Stripe's privacy policy at https://stripe.com/privacy. We require all subprocessors to maintain appropriate confidentiality and security measures.</p>

        <h2 className="text-xl font-semibold mt-8 mb-3">5. Sharing and Disclosure of Personal Information</h2>
        <p>We do not sell your personal information. We may share personal information: (a) with service providers and subprocessors who perform services on our behalf under appropriate confidentiality and data protection obligations; (b) to comply with law, legal process, or valid government requests; (c) to protect our rights, property, or safety or that of our users or the public; (d) in connection with a merger, acquisition, corporate reorganization, or sale of all or substantially all of our assets (with notice where required); or (e) with your consent. Aggregated or de-identified data that does not identify you may be used or shared for analytics, product improvement, research, or other lawful purposes.</p>
