...
import { ArrowUp, Search, Bell, LayoutGrid, Settings, Mic, ChevronLeft, ChevronRight, TrendingDown, Calendar, SlidersHorizontal, BookOpen, Target, Receipt, BarChart2, Wind, Sparkles, List, Check, TrendingUp, Activity, MessageCircle, FileText, Moon, Flame, Dumbbell, Droplets } from "lucide-react";
      ...
      <div className="hidden sm:flex justify-center pb-16 overflow-x-hidden">
        <div className="relative scale-[0.72] sm:scale-[0.82] lg:scale-100 origin-top" style={{ width: CON_W, height: CON_H, overflow: "visible" }}>
          ...
          <div className="absolute z-10" style={{ left: OCX, top: OCY, transform: "translate(-50%, -50%)" }}>
            ...
            >
              <Image src="/avatar.png" alt="Orryon" width={103} height={103} className="rounded-full object-contain ring-1 ring-white/10" />
            </motion.div>
          </div>
      ...
      <div className="sm:hidden px-4 pb-16">
        <div className="flex justify-center mb-8">
          <motion.div
            ...
            transition={{ duration: 3.8, ease: "easeInOut", repeat: Infinity }}
          >
            <Image src="/avatar.png" alt="Orryon" width={64} height={64} className="rounded-full object-contain ring-1 ring-white/10" />
          </motion.div>
        </div>
