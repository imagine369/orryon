                ...
                {thinking && (
                  <div className="flex w-full min-w-0 gap-3">
                    <Image
                      ...
                      width={28}
                      height={28}
                      className="mt-0.5 size-7 shrink-0 rounded-full object-contain bg-black ring-1 ring-white/10"
                    />
        ...
        <div className="absolute inset-0 flex flex-col">
          ...
          {!isChatMode && (
            <div className="flex-1 flex flex-col items-center justify-center px-4" style={{ paddingBottom: "max(50px, calc(20px + env(safe-area-inset-bottom)))" }}>
              <Image src="/avatar.png" alt="Orryon" width={80} height={80} className="rounded-full object-contain bg-black mb-5 ring-1 ring-white/10" />
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              <div ref={chatScrollRef} className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto px-4 py-4" style={{ scrollbarWidth: "none" }}>
                <div className="flex justify-center pb-1 pt-2">
                  <Image src="/avatar.png" alt="Orryon" width={80} height={80} className="rounded-full object-contain bg-black ring-1 ring-white/10" />
                </div>
                ...
                {thinking && (
                  <div className="flex w-full min-w-0 gap-3" style={{ animation: "msgIn 0.18s ease-out both" }}>
                    <Image src="/avatar.png" alt="Orryon" width={28} height={28} className="mt-0.5 size-7 shrink-0 rounded-full object-contain bg-black ring-1 ring-white/10" />
                    <div className="flex min-w-0 flex-1 flex-col">
  ...
  return (
    <div className="w-full flex flex-col gap-2.5">
      ...
      <div className="flex items-start gap-2">
        <Image src="/avatar.png" alt="Orryon" width={20} height={20} className="rounded-full object-contain bg-black mt-0.5 shrink-0" />
      ...
      <div className="hidden sm:flex justify-center pb-16 overflow-x-hidden">
        <div className="relative scale-[0.72] sm:scale-[0.82] lg:scale-100 origin-top" style={{ width: CON_W, height: CON_H, overflow: "visible" }}>
          ...
          <div className="absolute z-10" style={{ left: OCX, top: OCY, transform: "translate(-50%, -50%)" }}>
            ...
            >
              <Image src="/avatar.png" alt="Orryon" width={103} height={103} className="rounded-full object-contain bg-black ring-1 ring-white/10" />
            </motion.div>
          </div>
      ...
      <div className="sm:hidden px-4 pb-16">
        <div className="flex justify-center mb-8">
          <motion.div
            ...
            transition={{ duration: 3.8, ease: "easeInOut", repeat: Infinity }}
          >
            <Image src="/avatar.png" alt="Orryon" width={64} height={64} className="rounded-full object-contain bg-black ring-1 ring-white/10" />
          </motion.div>
        </div>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <FadeIn>
        <div className="flex flex-col items-center text-center pt-[90px] sm:pt-[150px] lg:pt-[210px] pb-0 px-4 sm:px-6 border-b border-white/5">
          ...
          >
            <Image src="/avatar.png" alt="Orryon — otherworldly personal concierge" width={103} height={103} className="w-[100px] h-[100px] sm:w-[103px] sm:h-[103px] lg:w-[130px] lg:h-[130px] rounded-full object-contain bg-black ring-1 ring-white/10" />
          </motion.div>
        ...
        {!loggedIn && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 3.8, ease: "easeInOut", repeat: Infinity, repeatType: "loop" }}
            >
              <Image src="/avatar.png" alt="Orryon" width={103} height={103} className="rounded-full object-contain bg-black ring-1 ring-white/10 lg:w-[130px] lg:h-[130px]" />
            </motion.div>
